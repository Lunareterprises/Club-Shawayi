...
function HomeAboutUs() {
  ...
  return (
    <div className="relative py-12 px-10 lg:px-32 bg-[#d42d21] flex flex-col justify-between lg:flex-row">
      <div>
      ...
      <div className="w-1/2 flex flex-col gap-3">
        ...
        <p className="text-sm font-bold text-white">Bangalore’s Favorite Masala Shawayi Brand is Expanding!</p>
        <p className="text-sm font-normal text-white">Do you dream of running a successful restaurant?
        ...
        <p className="text-sm font-normal text-white">With Expert Training, end - to - end operational support, and a strong brand presence, we guarantee a hassle - free and profitable business model. Our structured partnership system, high - profit margins, and strict quality control make C CLUB SHAWAYI the perfect choice for a spring restaurant. join us and be part of a thriving legacy!</p>
        <p className="text-sm font-normal text-white">C CLUB SHAWAYI is not just a restaurant -- it’s a brand built on authentic flavors, proven business strategies, and an unbreakable commitment to quality. our secret masala blend ensure an unmatched taste that keeps customers coming back for more.</p>
      </div>
    </div>
  );
}
