...
const Testimonials = () => {
  const testimonials = [
    ...
    {
      name: "Michael Brown",
      subhead: "michaelbrown@gmail.com",
    ...
    {
      name: "Emily Johnson",
      subhead: "emilyjohnson@gmail.com",
  ...
  return (
    <div className="relative overflow-visible">
      ...
      <div
          className="bg-[#d42d21] h-72 p-6 relative flex flex-col items-center overflow-visible bg-no-repeat"
          style={{
            backgroundImage: "url('/Images/Home/testinomialBG.png')",
            backgroundSize: "200px auto", // Adjust the size as needed
            backgroundPosition: "right bottom", // Place it at the left end
          }}
        >
              ...
              <div key={index} className="px-5 overflow-visible">
                <div className="relative bg-white shadow-lg p-6 text-center mt-14 overflow-visible">
                  ...
                  <div className="mt-12 h-32">
                    ...
                    <h4 className="text-lg font-semibold mt-2 text-[#D42D21]">
                      {testimonial.name}
                    </h4>
